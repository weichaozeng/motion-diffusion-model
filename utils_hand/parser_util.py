...
# loss
    ...
    group.add_argument("--lambda_res_pose", default=1.0)
    group.add_argument("--lambda_res_trans", default=1.0)
    
    # === Coordinate Origin Lock (保持不变：死死锁住首帧世界原点) ===
    group.add_argument("--lambda_ff_pose", default=10.0)
    ...
    group.add_argument("--lambda_vel_xyz", default=10000.0)
